...
For detailed endpoint specifications, see the [Look up incentives](/api-reference/incentives-lookups/look-up-incentives) API reference.
...
- [Look up incentives API Reference](/api-reference/incentives-lookups/look-up-incentives)
